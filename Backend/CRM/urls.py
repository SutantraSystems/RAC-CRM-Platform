...
from .views import RACStudentViewSet, UploadStudentsAPIView, student_count,BulkDeleteStudentsAPIView,student_ids, StudentDocumentListCreateView, StudentDocumentDeleteView, StudentCommentListCreateView, StudentCommentDetailView, StudentActivityListView
...
urlpatterns = [
    ...
    path("students/<int:student_id>/activity/", StudentActivityListView.as_view(), name="student-activity"),
